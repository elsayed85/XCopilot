...
const ask_gpt = async (message) => {
   let github_account =  document.getElementById("github_account_id");
    let github_id = github_account.value;
    if (github_id == "" || github_id == null) {
        alert("Please enter your github account id");
        return;
    }

    let github_is_shared = github_account.options[github_account.selectedIndex].getAttribute("data-shared");
                        ...
                        parts: [
                            {
                                content: message,
                                role: "user",
                                webSearch: document.getElementById("switch").checked,
                            },
                        ],
                    },
                },
